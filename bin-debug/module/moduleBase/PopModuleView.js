...
var PopModuleView = (function (_super) {
    ...
    PopModuleView.prototype.init = function () {
        ...
        // 退出ui的动画方式
        this.moduleFadeOutType = ModuleConsts.MODULE_FADE_OUT_TYPE_0;
    };
    PopModuleView.prototype.preShowCpl = function () {
        if (this.content['m_panelBg']) {
            if (this.content['m_panelBg']['m_btn_close']) {
                this.content['m_panelBg']['m_btn_close'].addClickListener(this.onCloseClick, this);
            }
        }
        _super.prototype.preShowCpl.call(this);
    };
    /**
     * 初始化模块自适应
    ...
    PopModuleView.prototype.onCloseClick = function () {
