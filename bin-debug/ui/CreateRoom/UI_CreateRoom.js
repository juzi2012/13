    ...
    (function (CreateRoom) {
        var UI_CreateRoom = (function (_super) {
            ...
            UI_CreateRoom.prototype.constructFromXML = function (xml) {
                ...
                this.m_btn_type5 = (this.getChildAt(6));
                this.m_btn_type2 = (this.getChildAt(7));
                this.m_btn_type3 = (this.getChildAt(8));
                this.m_btn_type4 = (this.getChildAt(9));
                this.m_btn_paytype0 = (this.getChildAt(10));
                this.m_btn_paytype1 = (this.getChildAt(11));
                this.m_btn_junum0 = (this.getChildAt(12));
                this.m_btn_junum1 = (this.getChildAt(13));
                this.m_btn_junum2 = (this.getChildAt(14));
                ...
                this.m_btn_shuoming = (this.getChildAt(53));
                this.m_btn_tonghuatype0 = (this.getChildAt(54));
                this.m_btn_tonghuatype1 = (this.getChildAt(55));
            };
