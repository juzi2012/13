    ...
    (function (Game) {
        var UI_PlayerHead = (function (_super) {
            ...
            UI_PlayerHead.prototype.constructFromXML = function (xml) {
                ...
                this.m_ = (this.getChildAt(12));
                this.m__2 = (this.getChildAt(13));
                this.m_chat_txt = (this.getChildAt(14));
                this.m_chat = (this.getChildAt(15));
                this.m_flower = (this.getChildAt(16));
                this.m_boom1 = (this.getChildAt(17));
                this.m_boom2 = (this.getChildAt(18));
