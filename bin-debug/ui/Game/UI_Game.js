    ...
    (function (Game) {
        var UI_Game = (function (_super) {
            ...
            UI_Game.prototype.constructFromXML = function (xml) {
                ...
                this.m_btn_talk = (this.getChildAt(5));
                this.m_btn_invite = (this.getChildAt(6));
                this.m_btn_chat = (this.getChildAt(7));
                this.m_sharetips = (this.getChildAt(10));
                this.m_txt_room = (this.getChildAt(12));
                this.m_txt_jushu = (this.getChildAt(13));
                this.m_txt_roomtype = (this.getChildAt(14));
                this.m_btn_start = (this.getChildAt(16));
                this.m_head5 = (this.getChildAt(17));
                this.m_head4 = (this.getChildAt(18));
                this.m_head2 = (this.getChildAt(19));
                this.m_head3 = (this.getChildAt(20));
                this.m_head6 = (this.getChildAt(21));
                this.m_head1 = (this.getChildAt(22));
