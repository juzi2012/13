...
(function (core) {
    var TimerManager = (function (_super) {
        ...
        function TimerManager() {
            ...
            _this._count = 0;
            _this._timeScale = 1;
            // let a:egret.EventDispatcher = new egret.EventDispatcher();
            // a.addEventListener(egret.Event.ENTER_FRAME,this.onEnterFrame,this);
            // egret.Ticker.getInstance().addEventListener(egret.Event.ENTER_FRAME,this.onEnterFrame,this);
