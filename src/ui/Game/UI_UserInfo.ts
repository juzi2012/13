...
module UI.Game {
	...
	export class UI_UserInfo extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_btn_close = <fairygui.GButton><any>(this.getChildAt(11));
			this.m_head = <fairygui.GComponent><any>(this.getChildAt(12));
			this.m_list = <fairygui.GList><any>(this.getChildAt(13));
		}
	}
}