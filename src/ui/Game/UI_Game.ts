...
module UI.Game {
	...
	export class UI_Game extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_head5 = <UI_PlayerHead><any>(this.getChildAt(5));
			this.m_head4 = <UI_PlayerHead><any>(this.getChildAt(6));
			this.m_head3 = <UI_PlayerHead><any>(this.getChildAt(7));
			this.m_head2 = <UI_PlayerHead><any>(this.getChildAt(8));
			this.m_head6 = <UI_PlayerHead><any>(this.getChildAt(9));
			this.m_head1 = <UI_PlayerHead><any>(this.getChildAt(10));
			this.m_btn_check = <fairygui.GButton><any>(this.getChildAt(13));
			this.m_btn_invite = <fairygui.GButton><any>(this.getChildAt(14));
			this.m_btn_ready = <fairygui.GButton><any>(this.getChildAt(15));
