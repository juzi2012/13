...
module UI.Game {
	...
	export class UI_Game extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_btn_invite = <fairygui.GButton><any>(this.getChildAt(5));
			this.m_btn_start = <fairygui.GButton><any>(this.getChildAt(6));
			this.m_head5 = <UI_PlayerHead><any>(this.getChildAt(7));
			this.m_head4 = <UI_PlayerHead><any>(this.getChildAt(8));
			this.m_head3 = <UI_PlayerHead><any>(this.getChildAt(9));
			this.m_head2 = <UI_PlayerHead><any>(this.getChildAt(10));
			this.m_head6 = <UI_PlayerHead><any>(this.getChildAt(11));
			this.m_head1 = <UI_PlayerHead><any>(this.getChildAt(12));
			this.m_btn_check = <fairygui.GButton><any>(this.getChildAt(15));
			this.m_btn_ready = <fairygui.GButton><any>(this.getChildAt(16));
			this.m_btn_chat = <fairygui.GButton><any>(this.getChildAt(17));
			this.m_btn_talk = <fairygui.GButton><any>(this.getChildAt(18));
			this.m_img_start = <fairygui.GImage><any>(this.getChildAt(19));
