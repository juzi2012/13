...
module UI.Game {
	...
	export class UI_Game extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_btn_talk = <fairygui.GButton><any>(this.getChildAt(5));
			this.m_btn_invite = <fairygui.GButton><any>(this.getChildAt(6));
			this.m_btn_chat = <fairygui.GButton><any>(this.getChildAt(7));
			this.m_sharetips = <fairygui.GGroup><any>(this.getChildAt(10));
			this.m_txt_room = <fairygui.GTextField><any>(this.getChildAt(12));
			this.m_txt_jushu = <fairygui.GTextField><any>(this.getChildAt(13));
			this.m_txt_roomtype = <fairygui.GTextField><any>(this.getChildAt(14));
			this.m_btn_start = <fairygui.GButton><any>(this.getChildAt(16));
			this.m_head5 = <UI_PlayerHead><any>(this.getChildAt(17));
			this.m_head4 = <UI_PlayerHead><any>(this.getChildAt(18));
			this.m_head2 = <UI_PlayerHead><any>(this.getChildAt(19));
			this.m_head3 = <UI_PlayerHead><any>(this.getChildAt(20));
			this.m_head6 = <UI_PlayerHead><any>(this.getChildAt(21));
			this.m_head1 = <UI_PlayerHead><any>(this.getChildAt(22));
