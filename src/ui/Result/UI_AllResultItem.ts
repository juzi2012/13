...
module UI.Result {
	...
	export class UI_AllResultItem extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_txt_ju0 = <fairygui.GTextField><any>(this.getChildAt(7));
			this.m_txt_ju1 = <fairygui.GTextField><any>(this.getChildAt(8));
			this.m_txt_ju2 = <fairygui.GTextField><any>(this.getChildAt(9));
			this.m_txt_ju3 = <fairygui.GTextField><any>(this.getChildAt(10));
			this.m_txt_ju4 = <fairygui.GTextField><any>(this.getChildAt(11));
			this.m_txt_ju5 = <fairygui.GTextField><any>(this.getChildAt(13));
			this.m_winner = <fairygui.GGroup><any>(this.getChildAt(16));
			this.m_txt_score = <fairygui.GTextField><any>(this.getChildAt(17));
		}
	}
}