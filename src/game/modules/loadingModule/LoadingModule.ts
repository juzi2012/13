	...
	export class LoadingModule extends Module implements RES.PromiseTaskReporter {
		...
		private startGame():void
		{
			...
			if(GameModel.ins.roomModel!=null&&GameModel.ins.roomModel.isReConnectInRoom){
				...
				HttpAPI.HttpGET("http://"+game.GameModel.ins.SocketServer+":8883/huifang",{'uid':OptModel.ins.shareUserId,'id':OptModel.ins.shareRePlayRoomId},this.onCallBack,this.onError,this);
			}else{
